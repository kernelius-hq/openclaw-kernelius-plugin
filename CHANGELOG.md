...
### Added
- Detailed CLI vs Plugin co-flow documentation in Getting Started guide
- Workflow diagrams showing how both components work together
- "When to use which" reference table
- Plugin vs CLI summary in main README
...
[0.3.2]: https://github.com/kernelius-hq/openclaw-kernelius-plugin/releases/tag/v0.3.2
